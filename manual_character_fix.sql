-- Manual Fix for Character Access Issue
-- Run this in your Supabase SQL Editor

-- The problem: Anonymous users can't see characters because the RLS policies
-- only grant access to 'public' role, but anonymous users use 'anon' role.
...
-- Step 2: Create new policies that include both 'public' and 'anon' roles
...
-- Step 3: Grant SELECT permissions to anon role
