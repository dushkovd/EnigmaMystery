...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'home.hero.subtitle': 'Dive into our role-playing games for friends – full of secrets, clues, and accusations.',
    ...
    'home.howItWorks.title': 'Game Flow',
    ...
    'home.altCta.title': 'Looking for a different story?',
    'home.altCta.button': 'Explore All Games',
    ...
    'game.charactersDesc': 'Each player must select a role from the list of available characters and read the character\'s secret privately. If you are using a phone, you can pass it to each player to make their choice and read their secret. We advise you to take a picture of your cards or write them down, so that you won\'t forget them during the game.',
    'game.secret': 'Secret:',
  ...
  bg: {
    ...
    'home.hero.titleEnd': '!',
    'home.hero.subtitle': 'Опитай нашите ролеви игри за приятели, пълни с тайни, улики и обвинения.',
    'home.hero.exploreGames': 'Разгледай Игрите',
    ...
    'home.howItWorks.title': 'Как Протича Една Игра?',
    'home.howItWorks.subtitle': ' ',
    ...
    'home.altCta.title': 'Търсите различна история?',
    'home.altCta.button': 'Разгледайте всички игри',
    ...
    'game.charactersDesc': 'Всеки играч трябва да избере роля от списъка и да се запознае с неговата тайна, без да я споделя с останалите (предайте устройството помежду си за да може всеки сам да избере своята роля). Съветваме да си ги снимате с личния телефон или да си ги запишете, за да не ги забравите по време на играта.',
    'game.secret': 'Тайна:',
