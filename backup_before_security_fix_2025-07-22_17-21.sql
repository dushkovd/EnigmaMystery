...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at", "is_anonymous") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 'c2430400-f839-4258-96c8-3c98c2cb2d21', 'authenticated', 'authenticated', 'darkdevil15@abv.bg', '$2a$10$FEWWyLBa2A1tTjCp3T6gAu7uu1Uz5tH5FoH7zePiw9xRq41WQ4Q.6', '2025-06-11 16:08:27.104388+00', NULL, '', NULL, '', NULL, '', '', NULL, '2025-06-19 16:24:25.850807+00', '{"provider": "email", "providers": ["email"]}', '{"sub": "c2430400-f839-4258-96c8-3c98c2cb2d21", "email": "darkdevil15@abv.bg", "email_verified": true, "phone_verified": false}', NULL, '2025-06-11 16:08:27.092484+00', '2025-06-19 16:24:25.863057+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false),
	...
	('00000000-0000-0000-0000-000000000000', '1547d5f6-6d28-4669-a470-842031db5f96', 'authenticated', 'authenticated', 'dushkovd@gmail.com', '$2a$10$V5kSB/SFrZ8g7MiykjAly.516BIO7YBh1YJ7VFeh/tt66ZwQ.Olhm', '2025-06-13 15:57:37.690208+00', NULL, '', '2025-06-11 15:31:40.804467+00', '', NULL, '', '', NULL, '2025-07-22 14:10:59.661421+00', '{"provider": "email", "providers": ["email"]}', '{"sub": "1547d5f6-6d28-4669-a470-842031db5f96", "email": "dushkovd@gmail.com", "email_verified": true, "phone_verified": false}', NULL, '2025-06-11 15:31:40.791316+00', '2025-07-22 14:10:59.676746+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false),
...
INSERT INTO "auth"."sessions" ("id", "user_id", "created_at", "updated_at", "factor_id", "aal", "not_after", "refreshed_at", "user_agent", "ip", "tag") VALUES
	...
	('c531ceae-564c-476c-a35a-5c4c8294e045', '1547d5f6-6d28-4669-a470-842031db5f96', '2025-07-22 14:10:59.661536+00', '2025-07-22 14:10:59.661536+00', NULL, 'aal1', NULL, NULL, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '46.232.158.186', NULL);
...
INSERT INTO "auth"."mfa_amr_claims" ("session_id", "created_at", "updated_at", "authentication_method", "id") VALUES
	...
	('c531ceae-564c-476c-a35a-5c4c8294e045', '2025-07-22 14:10:59.67888+00', '2025-07-22 14:10:59.67888+00', 'password', 'a547e30b-e871-48fa-8887-bd41feda3541');
...
INSERT INTO "auth"."refresh_tokens" ("instance_id", "id", "token", "user_id", "revoked", "created_at", "updated_at", "parent", "session_id") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 110, '4craveo7x53l', '1547d5f6-6d28-4669-a470-842031db5f96', false, '2025-07-22 14:10:59.670043+00', '2025-07-22 14:10:59.670043+00', NULL, 'c531ceae-564c-476c-a35a-5c4c8294e045'),
...
SELECT pg_catalog.setval('"public"."Characters_character_id_seq"', 40, true);
...
SELECT pg_catalog.setval('"public"."Clues_clue_id_seq"', 63, true);
...
SELECT pg_catalog.setval('"public"."Final_Reveal_reveal_id_seq"', 5, true);
...
SELECT pg_catalog.setval('"public"."Game_Variations_variation_id_seq"', 5, true);
...
SELECT pg_catalog.setval('"public"."Order_Items_order_item_id_seq"', 41, true);
...
SELECT pg_catalog.setval('"public"."Orders_order_id_seq"', 59, true);
...
SELECT pg_catalog.setval('"public"."Rounds_round_id_seq"', 15, true);
